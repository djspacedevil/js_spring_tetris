<script>
    ...
    <div class="container mx-auto flex items-center justify-center h-screen">
        <Card>
            <h1 class="mb-2 font-bold tracking-tight text-gray-900 dark:text-white">Dashboard</h1>
            <Button href="/Spiel">Neues Spiel</Button>
            <hr>
            <Button href="/Spielhistorie">Spielhistorie</Button>
            <hr>
            <Button href="/OffeneSpiele">Offene Spiele</Button>
            <hr>
        </Card>
    </div>