...
class STest {
    ...
    private final Integer c = PURPLE.value;
    ...
    void shouldTakeUpCorrectCellsWhenPlaced() {
        var grid = new Grid();
        var tetromino = new S(0, grid.getHeight() - 3);
    ...
    @Test
    void shouldProvideSType() {
        var tetromino = new S(0, 0);
        assertEquals(Type.S, tetromino.getType());
    }
    ...
    void shouldSerializeAppropriately() {
        ...
        assertEquals(Type.S, result.type());
